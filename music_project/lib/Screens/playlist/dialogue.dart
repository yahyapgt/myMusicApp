...
Future moredialogplaylist(
    context, index, musicList, formkey, playlistnamectrl, MusicPlayer data) {
  return showDialog(
    context: context,
...
Future editplaylist(
    index, context, formkey, playlistnamectrl, MusicPlayer data) {
...
void updateplaylistname(index, formkey, playlistnamectrl) {
  if (formkey.currentState!.validate()) {
    ...
    if (names.isEmpty) {
      ...
      final playlistname = MusicPlayer( names,  []);
